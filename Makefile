...
benchmark:
	...
	hyperfine --show-output --warmup 5 --runs 50 './native/Main' 'dotnet ./dotnet6-pinvoke/bin/Release/net6.0/DotNet6PInvoke.dll' './dotnet7aot-pinvoke/bin/Release/net7.0/linux-arm64/publish/DotNet7AotPInvoke'